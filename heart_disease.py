...
def main():
    ...
    st.markdown(
        ...
        <style>
        body {
            background-image: url("heartt.jpg");
            background-size: cover;
        }
        .reportview-container {
            background: rgba(10, 200, 50, 0.6);
            color: white;
            padding: 20px;
            border-radius: 10px;
        }
    ...
    if st.button("Predict"):
        ...
        try:
            loaded_model = pickle.load(open(r"C:\Users\Praneeth\Desktop\Classification_ml\final_svm_model.sav", 'rb'))
            loaded_scaler = pickle.load(open(r"C:\Users\Praneeth\Desktop\Classification_ml\scaler.sav", 'rb'))
